...
// Send an IPv6 UDP packet through an IPv4 tunnel (6to4)
...
#include <netinet/in.h>      // IPPROTO_RAW, IPPROTO_IP, IPPROTO_IPV6, IPPROTO_UDP, INET_ADDRSTRLEN, INET6_ADDRSTRLEN
...
int main(int argc, char **argv)
{
    ...
    // We will add 4 bytes of UDP data later. Can be anything you choose.
    datalen = 4;
    ...
    ip4hdr.ip_len = htons(IP4_HDRLEN + IP6_HDRLEN + UDP_HDRLEN + datalen);
