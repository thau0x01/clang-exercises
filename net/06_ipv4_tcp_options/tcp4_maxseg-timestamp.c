...
int main(int argc, char **argv)
{
    ...
    ip_opt_len = 0;
    ip_options[0] = 68u;
    ip_opt_len++; // Timestamp option
    ip_options[1] = 8u;
    ip_opt_len++; // Option length (bytes) - 40 is maximum
    ip_options[2] = 9u;
    ip_opt_len++; // Pointer
    ip_options[3] = 0u;
    ip_opt_len++; // Overflow and Flag
    ip_options[4] = 0u;
    ip_opt_len++; // Time in milliseconds (right-justified) - random here
    ip_options[5] = 0u;
    ip_opt_len++; // Time cont'd
    ip_options[6] = 67u;
    ip_opt_len++; // Time cont'd
    ip_options[7] = 78u;
    ip_opt_len++; // Time cont'd
